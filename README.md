...
I build practical tools at the intersection of Web3 support, automation, and data analysis that make blockchain data easier to understand. My projects include blockchain explorers, transaction trackers, support utilities, and workflow tools designed to help teams investigate issues more efficiently.
...
| Project | Description |
|--------|-------------|
| [DoraScan](https://github.com/Labronski/dorascan) | Multi-chain blockchain explorer — look up wallet addresses and transaction hashes across networks from one interface. Used ~600x/week. |
...
| [State Log Explorer](https://github.com/Labronski/state-log-explorer) | Parses raw JSON application state logs into a structured, readable format for debugging. |
...
[![Email](https://img.shields.io/badge/-Email-D14836?style=flat&logo=gmail&logoColor=white)](mailto:lawrencejab@gmail.com)
